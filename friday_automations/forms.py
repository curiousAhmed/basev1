...
from friday_automations.methods.methods import generate_choices
from friday_automations.models import MODEL_CHOICES, MailAutomation
from friday_widgets.forms import orginal_template_name
...
class AutomationForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["also_sent_to"] = fridayMultiSelectField(
    ...
    def clean(self):
        ...
        if isinstance(self.fields["also_sent_to"], fridayMultiSelectField):
