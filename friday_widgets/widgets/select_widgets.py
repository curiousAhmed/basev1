...
This module is used to write friday form select widgets
"""
...
class fridayMultiSelectWidget(forms.Widget):
    """
    fridayMultiSelectWidget
    """
    ...
    template_name = "friday_widgets/friday_multiselect_widget.html"
