"""
This module provides friday ModelForms for creating and managing leave-related data,
...
from friday_widgets.forms import fridayForm, fridayModelForm
from friday_widgets.widgets.friday_multi_select_field import fridayMultiSelectField
from friday_widgets.widgets.select_widgets import fridayMultiSelectWidget
...
class LeaveTypeForm(ConditionForm):
    ...
    employee_id = fridayMultiSelectField(
        queryset=Employee.objects.all(),
        widget=fridayMultiSelectWidget(
...
class LeaveRequestCreationForm(ModelForm):
    ...
    def as_p(self, *args, **kwargs):
        ...
        """
        context = {"form": self}
        table_html = render_to_string("friday_form.html", context)
        return table_html
...
class LeaveOneAssignForm(fridayModelForm):
    """
    ...
    Attributes:
        - employee_id: A fridayMultiSelectField representing the employee to assign leave to.
    """
...
class AssignLeaveForm(fridayForm):
    """
    Form for Payslip
    """
