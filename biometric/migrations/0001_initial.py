    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machine_type', models.CharField(choices=[('zk', 'ZKTeco Biometric'), ('anviz', 'Anviz Biometric'), ('cosec', 'Matrix COSEC Biometric'), ('dahua', 'Dahua Biometric')], max_length=18, null=True)),
                ('machine_ip', models.CharField(blank=True, default='', max_length=150, null=True)),
