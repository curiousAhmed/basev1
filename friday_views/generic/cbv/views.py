...
from friday.filters import FilterSet
from friday.group_by import group_by_queryset
from friday.friday_middlewares import _thread_locals
from friday_views import models
from friday_views.cbv_methods import (  # update_initial_cache,
    get_short_uuid,
    hx_request_required,
    paginator_qry,
    sortby,
...
from friday_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
from friday_views.templatetags.generic_template_filters import getattribute

logger = logging.getLogger(__name__)


@method_decorator(hx_request_required, name="dispatch")
class fridayListView(ListView):
    """
    fridayListView
    """
    ...
    template_name: str = "generic/friday_list_table.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # # update_initial_cache(request, CACHE, fridayListView)
    ...
    def get_context_data(self, **kwargs: Any):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[fridayListView] = context
        from friday.urls import path, urlpatterns
    ...
    def export_data(self, *args, **kwargs):
        ...
        class fridayListViewResorce(resources.ModelResource):
            """
        ...
        book_resource = fridayListViewResorce()
...
class fridaySectionView(TemplateView):
    """
    friday Template View
    """
    ...
    template_name = "generic/friday_section.html"
...
@method_decorator(hx_request_required, name="dispatch")
class fridayDetailedView(DetailView):
    """
    HorillDetailedView
    """

    title = "Detailed View"
    template_name = "generic/friday_detailed_view.html"
    header: dict = {
        "title": "friday",
        "subtitle": "friday Detailed View",
        "avatar": "",
    }
    body: list = []
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, fridayDetailedView)
...
@method_decorator(hx_request_required, name="dispatch")
class fridayTabView(TemplateView):
    """
    fridayTabView
    """

    view_id: str = get_short_uuid(3, "htv")
    template_name = "generic/friday_tabs.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, fridayTabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[fridayTabView] = context

        return context


@method_decorator(hx_request_required, name="dispatch")
class fridayCardView(ListView):
    """
    fridayCardView
    """
    ...
    template_name = "generic/friday_card.html"
    context_object_name = "queryset"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, fridayCardView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[fridayCardView] = context
        referrer = self.request.GET.get("referrer", "")
        if referrer:
            # Remove the protocol and domain part
            referrer = "/" + "/".join(referrer.split("/")[3:])
...
class fridayFormView(FormView):
    ...
    template_name = "generic/friday_form.html"
    ids_key: str = "instance_ids"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # update_initial_cache(request, CACHE, fridayFormView)
    ...
    def get_form(self, form_class=None):
        ...
        if not hasattr(self, "form"):
            ...
            if self.request.method == "GET":
                ...
                for dynamic_tuple in self.dynamic_create_fields:
                    ...
                    form.fields[field].widget.option_template_name = (
                        "friday_widgets/select_option.html",
                    )
            ...
            # CACHE.get(self.request.session.session_key + "cbv")[fridayFormView] = form
            self.form = form
        return self.form


@method_decorator(hx_request_required, name="dispatch")
class fridayNavView(TemplateView):
    """
    fridayNavView
    ...
    template_name = "generic/friday_nav.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, fridayNavView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[fridayNavView] = context
        return context


@method_decorator(hx_request_required, name="dispatch")
class fridayProfileView(DetailView):
    """
    GenericfridayProfileView
    """

    template_name = "generic/friday_profile_view.html"
    view_id: str = None
    filter_class: FilterSet = None
    push_url: str = None
    key_name: str = "pk"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, fridayProfileView)
