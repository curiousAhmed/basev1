...
from friday.signals import post_generic_delete, pre_generic_delete
from friday_views import models
from friday_views.cbv_methods import get_short_uuid, login_required, merge_dicts
from friday_views.forms import SavedFilterForm
from friday_views.generic.cbv.views import fridayFormView, fridayListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.fridayModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(fridayFormView):
    """
    SavedFilter
    """
...
class DynamiListView(fridayListView):
    """
...
class fridayDeleteConfirmationView(View):
    """
    ...
    def post(self, *args, **kwargs):
        ...
        return fridayFormView.HttpResponse()
