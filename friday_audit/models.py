...
from friday_audit.methods import remove_duplicate_history
...
class AuditTag(models.Model):
    ...
    class Meta:
        ...
        app_label = "friday_audit"


class fridayAuditInfo(models.Model):
    """
...
class fridayAuditLog(HistoricalRecords):
    """
    Model to store additional information for historical records.
    """

    # def __init__(self, *args, bases=None, **kwargs):
    #     super(fridayAuditLog, self).__init__(*args, **kwargs)
    #     self.is_friday_audit_log = True
...
def pre_create_friday_audit_log(sender, instance, *args, **kwargs):
    """
...
def post_create_friday_audit_log(sender, instance, *_args, **kwargs):
    """
    ...
    try:
        ...
        if isinstance(history_instance, fridayAuditLog):
