...
from friday_views.cbv_methods import login_required, permission_required
from friday_views.generic.cbv.views import (
    fridayCardView,
    fridayFormView,
    fridayListView,
    fridayNavView,
...
class ProjectsNavView(fridayNavView):
    """
    Nav bar
    """
...
class ProjectsList(fridayListView):
    """
    Projects list view
    """
...
class ProjectFormView(fridayFormView):
    """
...
class ProjectCardView(fridayCardView):
    """
    For card view
    """
...
# Remove the command lines after friday converted into CBV
