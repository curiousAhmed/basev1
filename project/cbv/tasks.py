...
@method_decorator(login_required, name="dispatch")
class TaskListView(fridayListView):
    """
...
@method_decorator(login_required, name="dispatch")
class TasksNavBar(fridayNavView):
    """
    navbar of teh page
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCreateForm(fridayFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskDetailView(fridayDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCardView(fridayCardView):
    """
