...
from friday_views.cbv_methods import login_required
...
class TimeSheetNavView(fridayNavView):
    """
    Nav bar
    """
...
class TimeSheetList(fridayListView):
    """
...
class TaskTimeSheet(TimeSheetList):
    ...
    def get_queryset(self):
        queryset = fridayListView.get_queryset(self)
        task_id = self.kwargs.get("task_id")
...
class TimeSheetFormView(fridayFormView):
    """
...
class TimeSheetCardView(fridayCardView):
    """
    For card view
    """
...
class TimeSheetDetailView(fridayDetailedView):
    """
