...
from friday_views.generic.cbv.views import fridayDetailedView, fridayListView
...
class ProjectsDueInMonth(fridayListView):
...
class ProjectDetailView(fridayDetailedView):
    """
