...
from friday.friday_apps import INSTALLED_APPS
...
DEFAULT_LDAP_CONFIG = {
    ...
    "BIND_DN": "cn=admin,dc=friday,dc=com",
    "BIND_PASSWORD": "friday",
    "BASE_DN": "ou=users,dc=friday,dc=com",
}
...
def load_ldap_settings():
    ...
    try:
        ...
        from friday_ldap.models import LDAPSettings
