...
This module defines the abstract base model `fridayModel` for the friday HRMS project.
The `fridayModel` provides common fields and functionalities for other models within
...
class fridayModel(models.Model):
    ...
    for models within the friday application.
    """
    ...
    friday_history = AuditlogHistoryField()
    objects = models.Manager()
    is_active = models.BooleanField(default=True, verbose_name=_("Is Active"))

    class Meta:
        """
        Meta class for fridayModel
        """
    ...
    def save(self, *args, **kwargs):
        ...
        super(fridayModel, self).save(*args, **kwargs)
...
auditlog.register(fridayModel, serialize_data=True)
