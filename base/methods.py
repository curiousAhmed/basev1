...
from friday.friday_apps import NESTED_SUBORDINATE_VISIBILITY
from friday.friday_middlewares import _thread_locals
from friday.friday_settings import friday_DATE_FORMATS, friday_TIME_FORMATS
...
def format_export_value(value, employee):
    ...
    if isinstance(value, time):
        ...
        for format_name, format_string in friday_TIME_FORMATS.items():
