...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='workrecords',
            name='shift_id',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='base.employeeshift'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='historicalattendance',
            name='history_tags',
            field=models.ManyToManyField(to='friday_audit.audittag'),
        ),
        migrations.AddField(
            model_name='historicalattendance',
            name='history_user',
