...
from friday.friday_settings import DYNAMIC_URL_PATTERNS, friday_DATE_FORMATS
from friday.methods import remove_dynamic_url
...
def work_record_export(request):
    ...
    format_string = friday_DATE_FORMATS.get(date_format)
