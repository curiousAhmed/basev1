...
class AttendanceActivity(fridayModel):
    """
    ...
    # New field for daily report
    daily_report = models.TextField(
        null=True,
        blank=True,
        verbose_name=_("Daily Report"),
        help_text=_("Employees can fill this out when clocking out."),
    )     
...
class BatchAttendance(fridayModel):
    """
...
class AttendanceRequestFile(fridayModel):
    file = models.FileField(upload_to="attendance/request_files")


class AttendanceRequestComment(fridayModel):
    """
...
class AttendanceOverTime(fridayModel):
    """
...
class AttendanceLateComeEarlyOut(fridayModel):
    """
...
class AttendanceValidationCondition(fridayModel):
    """
...
class AttendanceGeneralSetting(fridayModel):
    """
